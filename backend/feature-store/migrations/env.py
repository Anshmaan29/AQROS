...
``aqros_market_data``'s migrations/env.py exactly.
"""
...
from aqros_feature_store.adapters.orm import Base
...
async def run_migrations_online() -> None:
    ...
    from aqros_feature_store.adapters.db import create_engine
