...
the app uses, via Alembic's async-engine pattern. Mirrors
``aqros_market_data``'s and ``aqros_feature_store``'s migrations/env.py.
"""
...
async def run_migrations_online() -> None:
    ...
    from aqros_dataset_builder.adapters.db import create_engine
